...
const ComponentFourProp = (one, two, tree, four) => (
  <input one={one} two={two} tree={tree} four={four} />
);
const ComponentFiveProp = (one, two, tree, four, five) => (
  <input one={one} two={two} tree={tree} four={four} five={five} />
);
const ComponentSixProp = (one, two, tree, four, five, six) => (
  <input one={one} two={two} tree={tree} four={four} five={five} six={six} />
);
const ComponentSevenProp = (one, two, tree, four, five, six, seven) => (
  <input
    one={one}
    two={two}
    tree={tree}
